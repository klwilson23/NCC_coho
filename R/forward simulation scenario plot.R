...
jpeg(filename="Figures/productivity scenario.jpeg",width=6,height=5.5,units="in",res=600)
...
legend("bottomleft",title="AR(1) Scenario",c("Mean reverting","Random walk","Trend"),bty="n",lty=1,lwd=2,col=c("dodgerblue","darkgreen","orange"))
abline(h=mu,lty=2,lwd=1)
dev.off()
