...
temp3B <- jags.model(file="JAGS/forecasting model ar1.jags", data=datamcmc2 ,n.chains = n_chains, n.adapt=50000, quiet=FALSE,inits=init_fx)#, inits=inits)
...
saveRDS(result_forecast_metrics,file="Results/coho_forecasting_ar1.rds")
saveRDS(result_forecast_run,file="Results/coho_forecasting_popdyn_ar1.rds")
saveRDS(result_forecast_RS,file="Results/coho_forecasting_rec_ar1.rds")

saveRDS(datamcmc2,file="Data/jags_forecasting_data_ar1.rds")
